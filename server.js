...
app.post("/api/search", async (req,res) => {
  ...
  let prices = {};
  try { const r=await fetch("https://porkbun.com/api/json/v3/pricing/get",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({apikey:PORKBUN_API_KEY,secretapikey:PORKBUN_SECRET})}); const d=await r.json(); if(d.status==="SUCCESS") prices=d.pricing; } catch(e){}
